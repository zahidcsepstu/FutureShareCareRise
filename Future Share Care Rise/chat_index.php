...
<html lang="en">
    ...
    <link type="text/css" rel="stylesheet" href="public_t/css/main.css"/>
    </head>
...
<li><a href="http://localhost/Loogin/connnnnn/index.php">Contact</a></li>
  ...
  <br>
    ...
    <div class= "input">
          ...
          <pre>Private chat(among teachers only) </pre>
          ...
          <script type="text/javascript" src="scripts_t/js/jquery.js"></script>
          <script type="text/javascript" src="scripts_t/js/auto_chat.js"></script>
          <script type="text/javascript" src="scripts_t/js/send.js"></script>
